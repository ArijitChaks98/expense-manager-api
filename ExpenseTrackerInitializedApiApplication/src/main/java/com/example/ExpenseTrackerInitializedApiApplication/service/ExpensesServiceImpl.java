...
import com.example.ExpenseTrackerInitializedApiApplication.repository.ExpenseRepository;
...
public class ExpensesServiceImpl implements ExpenseService{
    ...
    // Method Implementation for pagination
    @Override
    ...
    // Method Implementation for getExpenseById
    @Override
    ...
    // Method Implementation for deleting
    @Override
    ...
    // Method Implementing for save the expense details in database
    @Override
    ...
    // Method Implementing for update the expense details
    @Override
